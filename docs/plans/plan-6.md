...
- **Test plan**:
  ...
  - Criterion 4: component tests reload partial storage, switch source/week through existing confirmation guards, prove completed owners are not re-coached in another week, and verify the connected-versus-owner completion choices never merge or silently change authority.
