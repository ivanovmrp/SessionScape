...
- **Acceptance criteria**:
  ...
  4. Completed setup offers an explicit owner-controlled dashboard choice: connected insights remain authoritative unless the owner confirms switching to labeled owner-entered insights. Reloading or changing source/week safely resumes at the globally first incomplete saved step; completed/existing workspaces are not re-coached each week or forced through a wizard.
